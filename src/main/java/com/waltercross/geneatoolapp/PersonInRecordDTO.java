...
public class PersonInRecordDTO {
	...
	public static PersonInRecord convert(PersonInRecordDTO dto) {
		return new PersonInRecord(PersonDTO.convert(dto.person),
		PersonRole.fromInt(dto.personType));
	}
	
	public static PersonInRecordDTO convert(PersonInRecord personInRecord) {
		return new PersonInRecordDTO(PersonDTO.convert(personInRecord.person), 
		personInRecord.personRole.value());
	}
}
